<?php
/**
 * Smart Block Slider Pro Core Functions
 *
...
if ( ! function_exists( 'wpsbs_get_template_pro' ) ) :
     ...
     */
    function wpsbs_get_template_pro( $template_name, $args = array(), $template_path = '' ) {

        // Default Pro template path
        if ( empty( $template_path ) ) :
            $template_path = WPSBS_PRO_PATH . '/templates/';
        endif;
        ...
        if ( ! file_exists( $template ) ) :
            return new WP_Error(
                ...
                sprintf(
                    ...
                    esc_html__( '%s does not exist.', 'smart-block-slider-pro' ),
                    '<code>' . esc_html( $template ) . '</code>'
                )
            );
        endif;

        do_action( 'wpsbs_pro_before_template_part', $template, $args, $template_path );
        ...
        do_action( 'wpsbs_pro_after_template_part', $template, $args, $template_path );
    }
